...
The dataset includes 52,519 pets.
...
The three most common pet names in Seattle are Lucy with 439 pets, Charlie with 387 pets, and Luna with 355 pets.
...
The `arrange(species, n)` option groups all cats together and all dogs together, with the names ordered by frequency within each species.
...
Names below the diagonal line are more common for cats than for dogs.
...
The relationship is positive. In general, as the proportion of cats with a given name increases, the proportion of dogs with that name also tends to increase.
